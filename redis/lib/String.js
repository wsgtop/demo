...
async function testString() {
  ...
  await redis.mset("test_String1", "redis_new1","test_String2", "redis_new2","test_String3", "redis_new3","test_String4", "redis_new4");
  const str8 = await redis.mget("test_String1","test_String2","test_String3","test_String4");
  ...
  await redis.msetnx("test_String", "hellow_redis_new_m1","test_String_m2", "hellow_redis_new_m2","test_String_m3", "hellow_redis_new_m3");
  const str12 = await redis.mget("test_String","test_String_m2","test_String_m3");
